            ...
            <div class="col-sm-8 m-auto">
                <div class="card">
                    <div class="card-body">
                        ...
                        @endif
                        <form action="{{route('categories.update',$category->id)}}" method="POST" class="theme-form theme-form-2 mega-form" enctype="multipart/form-data">
                            @csrf
                            @method('PUT')
                            <div class="form-group">
                                ...
                                <div style="font-family: fontawesome; font-size:20px">
                                    ...
                                    @endforeach
                                    <input type="text" id="icon" value="{{$category->icon}}"  class="form-control" name="icon" placeholder="icon">
                                </div>
                            </div>
