                    ...
                    <table class="table table_striped">
                        ...
                        @foreach($orders as $sl=>$order)
                            <tr>
                                ...
                                <td>{{ $order->rel_to_customer ? $order->rel_to_customer->name : 'N/A' }}</td>
                                ...
                                <td>
                                    @php
                                        if($order->status == 1){
                                            echo '<span class="badge bg-success">Placed</span>';
                                        }
                                    else if($order->status == 2){
                                            echo '<span class="badge bg-danger">Processing</span>';
                                        }
                                        else if($order->status == 3){
                                            echo '<span class="badge bg-warning text-dark">Packeging</span>';
                                        }
                                        else if($order->status == 4){
                                            echo '<span class="badge bg-dark">Ready to Deliver</span>';
                                        }
