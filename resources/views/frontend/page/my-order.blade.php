                                ...
                                <div class="ord_list_wrap border mb-4">
                                    <div class="ord_list_head gray d-flex align-items-center justify-content-between px-3 py-3">
                                        ...
                                        <div class="">
                                            ...
                                            <div class="delv_status"><span class="ft-medium small badge bg-<?php
                                                if ($order->status == 1) {
                                                    echo 'warning';
                                            ...
                                            <div class="row align-items-center justify-content-center m-0 py-4 br-bottom">
                                                <div class="col-xl-12 col-lg-12 col-md-12 col-12">
                                                    <div class="cart_single d-flex align-items-start mfliud-bot">
                                                        ...
                                                        @php
                                                            $category_id = $order_product->product->category_id;
                                                        @endphp
                                                        <div class="cart_single_caption pl-3">
                                                            ...
                                                            <p class="mb-2"><span class="text-dark medium">Size: {{ $order_product->size->name }}</span>, <span class="text-dark medium">Color: {{ $order_product->color->name }}</span></p>
