                                            ...
                                            <div class="text-left">
                                                @foreach ($all_color as $color)
                                                    <div class="form-check form-option form-check-inline mb-1">
                                                        ...
                                                        @endif
                                                        >
                                                        <label for="color{{ $color->id }}" class="checkbox-custom-label">{{ $color->name }}</label>
                                                    </div>
                                                @endforeach
                                            </div>
                                        </div>
                                            ...
                                            <div class="text-left pb-0 pt-2">
                                                @foreach ($all_size as $size)
                                                    <div class="form-check form-option form-check-inline mb-1">
                                                        ...
                                                        @endif
                                                        >
                                                        <label for="size{{ $size->id }}" class="checkbox-custom-label">{{ $size->name }}</label>
                                                    </div> 
                                                @endforeach
                                            </div>
                                        </div>
                        ...
                        <div class="col-xl-4 col-lg-4 col-md-6 col-6">
                            <div class="product_grid card b-0">
                                ...
                                <div class="card-footer b-0 p-0 pt-2 bg-white">
                                    ...
                                    <div class="text-left">
                                        <h5 class="fw-bolder fs-md mb-0 lh-1 mb-1"><a href="{{ route('details',$product->slug) }}">{{ $product->name }}</a></h5>
